...
<body>
    ...
    <div class="container relative flex flex-col mx-auto mt-24 rounded-lg overflow-auto border-4 border-white w-full">
        <div class="flex flex-col max-w-[300px] bg-blue-500 text-center py-10">
            <h1 class="text-3xl uppercase text-white font-bold border-b border-b-white pb-4">FILTER MOVIE</h1>
